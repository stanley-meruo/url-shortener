...
import { FaFacebookSquare, FaGithub, FaInstagram, FaPinterest, FaTwitter } from "react-icons/fa";

export default function Footer() {
  return (
    <section className="bg-[#35323e] text-white">
      <section className="grid space-y-8 py-14 px-5 xs:px-6 sm:px-8 md:flex md:justify-between md:pb-8 lg:px-14 xl:px-20 xxl:px-36">
        ...
        <div className="space-y-4 text-center mx-auto md:text-start lg:mr-0">
        ...
        <div className="space-y-4 text-center mx-auto md:text-start ">
        ...
        <div className="flex items-center justify-center gap-4 md:-mt-36 md:gap-2.5 lg:gap-4">
          <Link href="/">
            <FaFacebookSquare className="size-6 hover:text-cyan" />
          </Link>
          <Link href="/">
            <FaTwitter className="size-6 hover:text-cyan" />
          </Link>
          <Link href="/">
            <FaPinterest className="size-6 hover:text-cyan" />
          </Link>
          <Link href="/">
            <FaInstagram className="size-6 hover:text-cyan" />
          </Link>
        </div>
      </section>
      <div className="flex justify-center item-center gap-2 text-gray-500 text-sm pb-4">
        Copyright
        <Link
          href="https://github.com/stanley-meruo"
          target="_blank"
          rel="noopener noreferrer"
          className="flex item-center gap-1 hover:text-cyan"
        >
          &copy;Stanley Meruo
